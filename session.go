...
func NewSession(config *SessionConfig) (*Session, string, error) {
...
func (s *Session) Switch() (string, error) {
...
func (s *Session) AttachOrSwitch() (string, error) {
